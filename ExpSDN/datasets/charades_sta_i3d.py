...
class CHARADES_STA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return index, i3dfeat, None, None, tokens, torch.from_numpy(loc_start), torch.from_numpy(loc_end), \
               torch.from_numpy(localization), time_start, time_end, factor, ann['fps'], raw_tokens, torch.from_numpy(start_loc_offset), torch.from_numpy(end_loc_offset), ann['number_frames'], ann['video']
